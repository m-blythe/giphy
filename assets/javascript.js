$(document).ready(function () {
  ...
  //New Stuff to Test//
  $("#addDogBtn").on("click", function (event) {
    event.preventDefault();

    // Get the to-do "value" from the textbox and store it a variable
    var dog = $("#addDog").val().trim();


    var newDog = $("<button>");

    newDog.attr("class", "btn btn-success");
    newDog.attr("type", "button");
    newDog.attr("value", dog);
    newDog.append(dog);
    $("#btnContainer").append(newDog);
    console.log(newDog);
